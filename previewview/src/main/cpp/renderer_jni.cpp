...
Java_com_joyuiyeongl_previewview_Renderer_initContext(JNIEnv *env, jclass clazz) {
...
Java_com_joyuiyeongl_previewview_Renderer_setWindowSurface(JNIEnv *env, jclass clazz, jlong context,
                                                                  jobject jsurface) {
...
Java_com_joyuiyeongl_previewview_Renderer_getTexName(JNIEnv *env, jclass clazz, jlong context) {
    auto *nativeContext = reinterpret_cast<NativeContext *>(context);
    return nativeContext->textureId;
}

JNIEXPORT jboolean JNICALL
Java_com_joyuiyeongl_previewview_Renderer_renderTexture(JNIEnv *env, jclass clazz, jlong context,
                                                               jlong timestampNs,
...
Java_com_joyuiyeongl_previewview_Renderer_closeContext(JNIEnv *env, jclass clazz, jlong context) {
    auto *nativeContext = reinterpret_cast<NativeContext *>(context);
