...
object SurfaceViewRenderSurface {
    ...
    fun inflateNonBlockingWith(
        ...
        return inflateWith(parent, renderer,  /*nonBlocking=*/true)
    }
    ...
    fun inflateWith(
        ...
        return inflateWith(parent, renderer,  /*nonBlocking=*/false)
    }
    ...
    private fun inflateWith(
        ...
        val surfaceView =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.surface_view_render_surface, parent, true) as SurfaceView
        surfaceView.holder.addCallback(object : SurfaceHolder.Callback2 {
            override fun surfaceRedrawNeeded(holder: SurfaceHolder) {
                val surfaceViewDisplay = surfaceView.display
                if (surfaceViewDisplay != null) {
